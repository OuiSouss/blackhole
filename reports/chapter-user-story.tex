...
% L'API devra envoyer des requêtes pour interagir entre le client et le serveur.
% L'API devra pouvoir créer des routes afin d'actualiser la base de données et les tables de routage des serveurs BGP.
% L'API devra pouvoir supprimer des routes afin d'actualiser la base de données et les tables de routage des serveurs BGP.
% L'API devra permettre l'affichage des routes pour l'administrateur.
% L'API devra pouvoir mettre à jour les routes afin d'actualiser la base de données et les tables de routage des serveurs BGP.
% L'API devra recevoir et traiter les réponses obtenues.