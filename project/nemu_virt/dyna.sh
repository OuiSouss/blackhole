...
echo "launching border router"

$DYNA -P 7200 --idle-pc $IDLE_PC -i 3 -X -T 2003 \
 -p 1:PA-FE-TX -s 1:0:udp:11010:127.0.0.1:11009 -p 2:PA-FE-TX -s 2:0:udp:11016:127.0.0.1:11015 \
 $CISCO_IMAGE -C $BR_cfg &